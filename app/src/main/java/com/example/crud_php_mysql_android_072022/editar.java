...
public class editar extends AppCompatActivity {
    ...
    public void actualizar(View view) {
        ...
        final String direccion = edCorreo.getText().toString();  final ProgressDialog progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Actualizando....");
        progressDialog.show();

       StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.100.35/crud_android-php/actualizar.php",
