...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.100.35/crud_android-php/mostrar.php";
    Usuarios usuarios;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       adapter = new Adapter(this,employeeArrayList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            /***
             * para que salga como un submenu
             * @param parent
             * @param view
             * @param position
             * @param id
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.100.35/crud_android-php/eliminar.php",
